...
if random_seed is None:
    print(f"{node_id}: The random seed for the simulation is not provided. Using the default value of CSC file")
    ...
    print(f"{node_id}: The random seed for the simulation: {random_seed}")
...
print(f"{node_id}: Exiting from Python UDP WSN Server")
