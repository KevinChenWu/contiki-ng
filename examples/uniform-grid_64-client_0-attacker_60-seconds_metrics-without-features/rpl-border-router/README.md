...
---
The Python UDP WSN Server IP and Contiki-NG Cooja RPL Border Router server port can be provided to the `border-router.c` make command line thru the variables `PREFIX` and `COOJA_RPL_BR_SERVER_PORT`.
For example in the terminal:

    >make TARGET=z1 connect-router-cooja PREFIX=fd00::1/64 COOJA_RPL_BR_SERVER_PORT=60001
