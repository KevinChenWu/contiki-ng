...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd35 FEATURES_SEND_INTERVAL=40</commands>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-attacker.z1 TARGET=z1 WSN_SERVER_IP=0xfd35 FEATURES_SEND_INTERVAL=40</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.6630303030303029 0.0 0.0 1.6630303030303029 38.090909090909115 15.090909090909118</viewport>
    </plugin_config>
...
while (true) {
  ...
  <plugin>
    ...
    <bounds x="1" y="401" height="126" width="362" z="2" />
  </plugin>
</simconf>
