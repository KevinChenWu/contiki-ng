...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd3c FEATURES_SEND_INTERVAL=47</commands>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-attacker.z1 TARGET=z1 WSN_SERVER_IP=0xfd3c FEATURES_SEND_INTERVAL=47</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.187878787878788 0.0 0.0 1.187878787878788 38.09090909090908 15.09090909090907</viewport>
    </plugin_config>
