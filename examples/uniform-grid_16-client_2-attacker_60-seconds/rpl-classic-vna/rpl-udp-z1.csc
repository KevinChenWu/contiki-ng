...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd12 FEATURES_SEND_INTERVAL=60</commands>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-attacker.z1 TARGET=z1 WSN_SERVER_IP=0xfd12 FEATURES_SEND_INTERVAL=60</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.7717171717171714 0.0 0.0 2.7717171717171714 38.09090909090911 15.090909090909118</viewport>
    </plugin_config>
  ...
  <plugin>
    ...
    <bounds x="901" y="1" height="401" width="753" z="2" />
  </plugin>
  <plugin>
...
while (true) {
  ...
  <plugin>
    ...
    <bounds x="0" y="401" height="126" width="362" z="1" />
  </plugin>
</simconf>
