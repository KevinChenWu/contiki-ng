...
uint8_t vna_mode = 0;
char features[UIP_CONF_BUFFER_SIZE - 56 + 1] = "00000,   ,     ,   ,                 ,                 ,   ,   ,   ,   ,   ,   ,   , ,A soft breeze rustled the leaves as distant waves crashed against the shore. In the quiet town, lanterns flickered, casting warm glows on cobblestone streets. A cat stretched lazily on a windowsill, watching the world with half-closed eyes. Somewhere, music played a violin's gentle melody drifting through the night, weaving dreams in the hearts of those who listened.-";
...
PROCESS_THREAD(udp_client_process, ev, data)
{
  ...
  //static char str[UIP_CONF_BUFFER_SIZE - 56 + 1];
