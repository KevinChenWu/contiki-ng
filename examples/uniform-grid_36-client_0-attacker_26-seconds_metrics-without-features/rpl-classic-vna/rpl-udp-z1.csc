...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd1f FEATURES_SEND_INTERVAL=26</commands>
...
my_output = new FileWriter("uniform-grid_36-client_0-attacker_26-seconds_metrics-without-features.csv");
