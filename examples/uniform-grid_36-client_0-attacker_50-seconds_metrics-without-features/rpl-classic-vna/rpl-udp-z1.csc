...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd22 FEATURES_SEND_INTERVAL=50</commands>
...
my_output = new FileWriter("uniform-grid_36-client_0-attacker_50-seconds_metrics-without-features.csv");
