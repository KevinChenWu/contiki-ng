...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <description>Z1 Mote Type #root</description>
    ...
    <motetype>
      org.contikios.cooja.mspmote.Z1MoteType
      <description>Z1 Mote Type #leaf</description>
    ...
    <motetype>
      org.contikios.cooja.mspmote.Z1MoteType
      <description>Z1 Mote Type #attacker</description>
      <source>[CONFIG_DIR]/udp-attacker.c</source>
      <commands>$(MAKE) -j$(CPUS) udp-attacker.z1 TARGET=z1</commands>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="21.77716734274071" y="46.96181437506209" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>9</id>
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="7.116495896607429" y="-91.7093401331308" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.mspmote.interfaces.MspMoteID
          <id>10</id>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.1144744203908952 0.0 0.0 1.1144744203908952 40.008558632914045 109.93498641657513</viewport>
    </plugin_config>
