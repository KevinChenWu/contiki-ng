...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-client.z1 TARGET=z1 WSN_SERVER_IP=0xfd17 FEATURES_SEND_INTERVAL=50</commands>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) udp-attacker.z1 TARGET=z1 WSN_SERVER_IP=0xfd17 FEATURES_SEND_INTERVAL=50</commands>
